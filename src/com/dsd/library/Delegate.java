...
public class Delegate implements Runnable {
    ...
    private LibraryManagementServer library;

    public Delegate(Integer port, LibraryManagementServer library){
        this.port = port;
...
class RequestHandler implements Runnable {
    ...
    private LibraryManagementServer myServer = null;
    ...
    public RequestHandler(LibraryManagementServer myServer, DatagramSocket mySocket, DatagramPacket receiver){
